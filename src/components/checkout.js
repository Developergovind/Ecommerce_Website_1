                                                ...
                                                <div className="col">
                                                    <div className="form-outline">
                                                        <input
                                                            ...
                                                            className="form-control"
                                                        />
                                                        <label className="form-label" htmlFor="formNameOnCard">
                                                            Name on card
                                                        </label>
                                                    </div>
                                                </div>
                                                <div className="col">
                                                    <div className="form-outline">
                                                        <input
                                                            ...
                                                            className="form-control"
                                                        />
                                                        <label className="form-label" htmlFor="formCardNumber">
                                                            Credit card number
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="row mb-4">
                                                <div className="col-3">
                                                    <div className="form-outline">
                                                        <input
                                                            ...
                                                            className="form-control"
                                                        />
                                                        <label className="form-label" htmlFor="formExpiration">
                                                            Expiration
                                                        </label>
                                                    </div>
                                                </div>
                                                <div className="col-3">
                                                    <div className="form-outline">
                                                        ...
                                                        <label className="form-label" htmlFor="formCVV">
                                                            CVV
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <button style={{ backgroundColor: ' #008178', color: "white" }}
